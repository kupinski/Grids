...
public struct LinearSpace<T: BinaryFloatingPoint & Codable> : Codable {
...
public struct PixelGrid<T: BinaryFloatingPoint & SIMDScalar & Codable> : Codable {
...
public struct VoxelGrid<T: BinaryFloatingPoint & SIMDScalar & Codable> : Codable {
