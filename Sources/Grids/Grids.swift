/*
   * [Ziteo, Inc] ("Ziteo") CONFIDENTIAL
   * Unpublished Copyright (c) 2022 [Ziteo, Inc], All Rights Reserved.
   *
   * NOTICE:  All information contained herein is, and remains the property of Ziteo. The intellectual
   * and technical concepts contained herein are proprietary to Ziteo and may be covered by U.S. and
   * Foreign Patents, patents in process, and are protected by trade secret or copyright law.
   * Dissemination of this information or reproduction of this material is strictly forbidden unless
   * prior written permission is obtained from Ziteo. Access to the source code contained herein is
   * hereby forbidden to anyone except current Ziteo employees, managers or contractors who have
   * executed Confidentiality and Non-disclosure agreements explicitly covering such access.
   *
   * The copyright notice above does not evidence any actual or intended publication or disclosure of
   * this source code, which includes information that is confidential and/or proprietary, and is a
   * trade secret, of  Ziteo.   ANY REPRODUCTION, MODIFICATION, DISTRIBUTION, PUBLIC  PERFORMANCE, OR
   * PUBLIC DISPLAY OF OR THROUGH USE  OF THIS  SOURCE CODE  WITHOUT  THE EXPRESS WRITTEN CONSENT OF
   * Ziteo IS STRICTLY PROHIBITED, AND IN VIOLATION OF APPLICABLE LAWS AND INTERNATIONAL TREATIES. THE
